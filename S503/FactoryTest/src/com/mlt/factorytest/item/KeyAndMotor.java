 ...
 *            the interface
 * @author: peisaisai
 * @date: 2015-01-15 13:44:32 Copyright (c) 2015, mlt All Rights Reserved.
 */
public class KeyAndMotor extends AbsHardware {
    ...
    private final int TESTCASE_MAX_NUM = 7;
    ...
    /**
     * @MethodName: judgeKeyMotorExit
     * @Description:In order to determine whether the test over
     * @return void
     * @throws Copyright
    ...
    public View getView(Context context) {
        ...
        mtvPower = (TextView) view.findViewById(R.id.mtvpower);
     ...
     * 
     * @see com.mlt.factorytest.item.AbsHardware#onKeyDown(int,
     * android.view.KeyEvent) Copyright (c) 2015, mlt All Rights Reserved.
     */
    @Override
     ...
     * @author: peisaisai
     * @date: 2015-01-15 11:45:33 Copyright (c) 2015, mlt All Rights
     *        Reserved.
     */
