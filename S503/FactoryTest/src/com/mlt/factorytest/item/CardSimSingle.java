 ...
 *            the corresponding
 * @author: peisaisai
 * @date: 2015-01-15 13:47:25 Copyright (c) 2015, mlt All Rights Reserved.
 */
public class CardSimSingle extends AbsHardware {
    ...
    private final String TNAME = "SD";
    private final String FLASHNAME = "Phone storage";
    private final String USBNAME = "External USB storage";
    ...
    private void getSimInfo() {
        ...
        mSimInfoList = SimInfoManager.getInsertedSimInfoList(context);
        ...
        for (int i = 0; i < mSimInfoList.size(); i++) {
            // Log.i("pss", "siminfo.mDisplayName = " +
            // mSimInfoList.get(i).mDisplayName);
            // Log.i("pss", "siminfo.mNumber = " + mSimInfoList.get(i).mNumber);
            slot = mSimInfoList.get(i).mSimSlotId;
            if (slot == 0) {
                mSim1CardInfoId = mSimInfoList.get(i).mSimInfoId;
            } else if (slot == 1) {
                mSim2CardInfoId = mSimInfoList.get(i).mSimInfoId;
            }
        }
    }
     ...
     * @author: peisaisai
     * @date: 2015-01-15 14:01:26 Copyright (c) 2015, mlt All Rights
     *        Reserved.
     */
    ...
    private void simCardTest() {
        ...
        if (!isGeminiEnabled()) {
            ...
            imsi_1 = mTelephonyManagerEx
                    .getSubscriberId(PhoneConstants.GEMINI_SIM_1);
            imsi_2 = mTelephonyManagerEx
                    .getSubscriberId(PhoneConstants.GEMINI_SIM_2);
        ...
        public void handleMessage(Message msg) {
            if (UPDATE_SIMCARDANDSIGLE == msg.what) {
                ...
                if (mIsMountedUSB) {
                    ...
                    mtvTSize.setText(mUSBAvailableSize
                            + context.getString(R.string.mtvseperator)
