...
import com.mlt.factorytest.item.nfc.NfcCommand.DataConvert;
...
public class NfcEmReqRsp {
    ...
    public static class NfcEmOptionReq extends NfcEmReq {
        ...
        public void writeRaw(ByteBuffer buffer) throws NullPointerException,
            ...
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_test_mode_setting_req forceDownload: " + mForceDownload);
            buffer.put(DataConvert.shortToLH(mAutoCheck));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_test_mode_setting_req tagAutoPresenceChk: " + mAutoCheck);
        }
    ...
    public static class NfcEmOptionRsp {
        ...
        public void readRaw(ByteBuffer buffer) throws NullPointerException,
                BufferUnderflowException {
            mResult = buffer.get();
            Log.d(NfcMainPage.TAG, "NfcEmOptionRsp result: " + mResult);
        }
    ...
    public static class NfcEmLoopbackReq extends NfcEmReq {
        ...
        public void writeRaw(ByteBuffer buffer) throws NullPointerException,
                BufferOverflowException {
            buffer.put(mAction);
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_loopback_test_req action: " + mAction);
        }
    ...
    public static class NfcEmLoopbackRsp{
        ...
        public void readRaw(ByteBuffer buffer) throws NullPointerException,
                BufferUnderflowException {
            mResult = buffer.get();
            Log.d(NfcMainPage.TAG, "NfcEmLoopbackRsp result: " + mResult);
        }
    ...
    public static class NfcEmSwpReq extends NfcEmReq {
        ...
        public void writeRaw(ByteBuffer buffer) throws NullPointerException,
            ...
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_fm_swp_test_req action: " + mAction);
        }
    ...
    public static class NfcEmPnfcReq extends NfcEmReq {
        ...
        public void writeRaw(ByteBuffer buffer) throws NullPointerException,
                BufferOverflowException {
            buffer.put(DataConvert.intToLH(mAction));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_em_pnfc_req action: " + mAction);
            buffer.put(DataConvert.intToLH(mDataLen));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_em_pnfc_req datalen: " + mDataLen);
            buffer.put(mData, 0, mDataLen);
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_em_pnfc_req data: " + new String(mData));
        }
    ...
    public static class NfcEmVirtualCardReq extends NfcEmReq {
        ...
        public void writeRaw(ByteBuffer buffer) throws NullPointerException,
                BufferOverflowException {
            buffer.put(DataConvert.intToLH(mAction));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_victual_card_req action: " + mAction);
            buffer.put(DataConvert.intToLH(mSupportType));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_victual_card_req supporttype: "
                    + mSupportType);
            // buffer.put(DataConvert.intToLH(mTypeADataRate));
            // Log.d(NfcMainPage.TAG,
            ...
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_victual_card_req typeF_datarate: "
                    + mTypeFDataRate);
        }
    ...
    public static class NfcEmTxCarrAlsOnReq extends NfcEmReq {
        ...
        public void writeRaw(ByteBuffer buffer) throws NullPointerException,
                BufferOverflowException {
            buffer.put(DataConvert.intToLH(mAction));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_tx_carr_als_on_req action: " + mAction);
        }
    ...
    public static class NfcEmPollingReq extends NfcEmReq {
        ...
        public void writeRaw(ByteBuffer buffer) throws NullPointerException,
                BufferOverflowException {
            buffer.put(DataConvert.intToLH(mAction));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_polling_req action: " + mAction);
            buffer.put(DataConvert.intToLH(mPhase));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_polling_req phase: " + mPhase);
            buffer.put(DataConvert.intToLH(mPeriod));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_polling_req period: " + mPeriod);
            buffer.put(DataConvert.intToLH(mEnableFunc));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_polling_req enablefunc: "
                    + mEnableFunc);
            mP2pmReq.writeRaw(buffer);
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_polling_req write p2p.");
            mCardmReq.writeRaw(buffer);
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_polling_req write card mode.");
            mReadermReq.writeRaw(buffer);
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_polling_req write reader mode.");
        }
    ...
    public static class NfcEmPollingNty implements RawOperation {
        ...
        public void readRaw(ByteBuffer buffer) throws NullPointerException,
            ...
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_polling_ntf detecttype: "
                    + mDetectType);
    ...
    public static class NfcEmAlsP2pReq extends NfcEmReq {
        ...
        public void writeRaw(ByteBuffer buffer) throws NullPointerException,
                BufferOverflowException {
            buffer.put(DataConvert.intToLH(mAction));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_p2p_req action: " + mAction);
            buffer.put(DataConvert.intToLH(mSupportType));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_p2p_req supporttype: "
                    + mSupportType);
            buffer.put(DataConvert.intToLH(mTypeADataRate));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_p2p_req typeA_speedrate: "
                    + mTypeADataRate);
            buffer.put(DataConvert.intToLH(mTypeFDataRate));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_p2p_req typeV_speedrate: "
                    + mTypeFDataRate);
            buffer.put(DataConvert.intToLH(mMode));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_p2p_req mode: " + mMode);
            buffer.put(DataConvert.intToLH(mRole));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_p2p_req role: " + mRole);
            buffer.put(DataConvert.intToLH(mIsDisableCardM));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_p2p_req isDisableCardM: "
                    + mIsDisableCardM);
        }
...
//            mData = new byte[DATA_MAX_LENGTH];
        ...
        public void readRaw(ByteBuffer buffer) throws NullPointerException,
                BufferUnderflowException {
            mResult = DataConvert.byteToInt(DataConvert.getByteArr(buffer));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_em_als_p2p_ntf result: " + mResult);
//            mDataLen = DataConvert.byteToInt(DataConvert.getByteArr(buffer));
//            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_em_als_p2p_ntf datalen: " + mDataLen);
//            buffer.get(mData, 0, mDataLen);
//            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_em_als_p2p_ntf data: "
//                    + new String(mData));
        }
...
//            buffer.put(mData, 0, mDataLen);
    ...
    public static class NfcEmAlsCardmReq extends NfcEmReq {
        ...
        public void writeRaw(ByteBuffer buffer) throws NullPointerException,
                BufferOverflowException {
            buffer.put(DataConvert.intToLH(mAction));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_cardm_req action: " + mAction);
            buffer.put(DataConvert.intToLH(mSwNum));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_cardm_req SWNum: " + mSwNum);
            buffer.put(DataConvert.intToLH(mSupportType));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_cardm_req supporttype: "
                    + mSupportType);
            buffer.put(DataConvert.intToLH(mFgVirtualCard));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_cardm_req fgvirtualcard: "
                    + mFgVirtualCard);
        }
    ...
    public static class NfcEmAlsReadermReq extends NfcEmReq {
        ...
        public void writeRaw(ByteBuffer buffer) throws NullPointerException,
                BufferOverflowException {
            buffer.put(DataConvert.intToLH(mAction));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_readerm_req action: " + mAction);
            buffer.put(DataConvert.intToLH(mSupportType));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_readerm_req supporttype: "
                    + mSupportType);
            buffer.put(DataConvert.intToLH(mTypeADataRate));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_readerm_req typeA_datarate: "
                    + mTypeADataRate);
            buffer.put(DataConvert.intToLH(mTypeBDataRate));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_readerm_req typeB_datarate: "
                    + mTypeBDataRate);
            buffer.put(DataConvert.intToLH(mTypeVDataRate));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_readerm_req typeV_datarate: "
                    + mTypeVDataRate);
            buffer.put(DataConvert.intToLH(mTypeFDataRate));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_readerm_req typeF_datarate: "
                    + mTypeFDataRate);
            buffer.put(DataConvert.intToLH(mTypeVSubcarrier));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_readerm_req typeV_subcarrier: "
                    + mTypeVSubcarrier);
            buffer.put(DataConvert.intToLH(mTypeVCodingMode));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_readerm_req typeV_codingmode: "
                    + mTypeVCodingMode);
        }
    ...
    public static class NfcEmAlsReadermNtf implements RawOperation {
        ...
        public void readRaw(ByteBuffer buffer) throws NullPointerException,
                BufferUnderflowException {
            mResult = DataConvert.byteToInt(DataConvert.getByteArr(buffer));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_em_als_readerm_ntf result: " + mResult);
            mIsNdef = DataConvert.byteToInt(DataConvert.getByteArr(buffer));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_em_als_readerm_ntf isNDEF: " + mIsNdef);
            mUidLen = DataConvert.byteToInt(DataConvert.getByteArr(buffer));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_em_als_readerm_ntf UidLen: " + mUidLen);
            buffer.get(mUid, 0, mUidLen);
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]s_mtk_nfc_em_als_readerm_ntf mUid: "
                    + new String(mUid));
        }
    ...
    public static class NfcEmAlsReadermOptReq extends NfcEmReq {
        ...
        public void writeRaw(ByteBuffer buffer) throws NullPointerException,
                BufferOverflowException {
            buffer.put(DataConvert.intToLH(mAction));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_readerm_opt_req action: "
                    + mAction);
    ...
    public static class NfcEmAlsReadermOptRsp implements RawOperation {
        ...
        public void readRaw(ByteBuffer buffer) throws NullPointerException,
                BufferUnderflowException {
            mResult = DataConvert.byteToInt(DataConvert.getByteArr(buffer));
            Log.d(NfcMainPage.TAG, "[NfcEmReqRsp]mtk_nfc_em_als_readerm_opt_rsp result: "
                    + mResult);
...
//      } s_mtk_nfc_tag_read_ndef;
    ...
    public abstract static class NfcEmRsp implements RawOperation {
        ...
        public void readRaw(ByteBuffer buffer) throws NullPointerException,
                BufferUnderflowException {
            mResult = DataConvert.byteToInt(DataConvert.getByteArr(buffer));
            Log.d(NfcMainPage.TAG, "NfcEmRsp result: " + mResult);
        }
