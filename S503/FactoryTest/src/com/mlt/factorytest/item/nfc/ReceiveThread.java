    ...
    public void run() {
        ...
        while (mRunning) {
            try {
                ...
                Log.d(NfcMainPage.TAG, "[ReceiveThread:info]Recieved data message type is "
                        + msgType);
                if (msgType > CommandType.MTK_NFC_EM_MSG_END) {
                    Log.v(NfcMainPage.TAG,
                    ...
                    Log.d(NfcMainPage.TAG, "[ReceiveThread:info]Recieved data message lenght is "
                            + msgLen);
                ...
                Log.v(NfcMainPage.TAG, "[ReceiveThread]receive thread IOException: " + errorMsg);
