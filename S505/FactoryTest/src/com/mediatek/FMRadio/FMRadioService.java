...
//    private IBluetoothA2dp mA2dpService = null;
    ...
    private boolean openDevice() {
        ...
        if (!mIsDeviceOpen) {
            ...
            if (mIsDeviceOpen) {
            	Intent intent=new Intent("com.malata.fm.opendevice.success");
           	 sendBroadcast(intent);
			}else {
		     Intent intent=new Intent("com.malata.fm.opendevice.fail");
           	 sendBroadcast(intent);
			}
        }
...
//            showNotification();
    ...
    public boolean isActivityForeGround() {
        ...
        return "com.mlt.factorytest".equals(componentInfo.getPackageName().toString());
    }
