 ...
 * @author: peisaisai
 * @date: 2015-01-15 14:57:52 Copyright (c) 2015, mlt All Rights Reserved.
 */
public class GPSAdmin {
    ...
    /**
     * @MethodName: initGPS
     * @Description: Initialize the GPS, which open the GPS monitoring, as well
     *               as the GPS satellite state monitoring
     * @return void
     * @throws Copyright
