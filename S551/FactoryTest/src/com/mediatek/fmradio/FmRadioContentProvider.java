...
public class FmRadioContentProvider extends ContentProvider {
     ...
     *            The uri to delete
     * @param selection
     *            The where cause to apply, if null will delete all rows
     * @param selectionArgs
     *            The select value
     * 
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        case STATION_FREQ_ID:
            ...
            rows = mSqlDb.delete(TABLE_NAME, FmRadioStation.Station._ID
                    + "="
                    + stationID
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        rowUri = ContentUris.appendId(
                FmRadioStation.Station.CONTENT_URI.buildUpon(), rowId).build();
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        case STATION_FREQ_ID:
            String stationID = uri.getPathSegments().get(1);
            rows = mSqlDb.update(TABLE_NAME, values, FmRadioStation.Station._ID
                    + "="
                    + stationID
                    + (TextUtils.isEmpty(selection) ? "" : " AND (" + selection
                            + ")"), selectionArgs);
