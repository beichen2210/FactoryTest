...
public class CardSimSingle extends AbsHardware {
    ...
    private List<SubInfoRecord> mSimInfoList = new ArrayList<SubInfoRecord>();
    ...
    private void getSimInfo() {
        ...
        mSimInfoList = SubscriptionManager.getAllSubInfoList();
        ...
        for (int i = 0; i < mSimInfoList.size(); i++) {
            slot = mSimInfoList.get(i).slotId;
            if (slot == 0) {
                mSim1CardInfoId = mSimInfoList.get(i).subId;
            } else if (slot == 1) {
                mSim2CardInfoId = mSimInfoList.get(i).subId;
            }
