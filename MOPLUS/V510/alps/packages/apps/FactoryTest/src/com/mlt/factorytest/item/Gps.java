...
/** 
* @ClassName: Gps 
* @Description: modify for VFOZESGW-74
* @Function: add the num 
* @author:   peisaisai
* @date:     20150805 pm4:04:22 
* @time: pm4:04:22 
* Copyright (c) 2015,  Malata All Rights Reserved.
...
public class Gps extends AbsHardware {
    ...
    private TextView mbtnGpsConnect,mtvPosTime,mbtnGpsConnect1;
    ...
    private final int GPS_MAX_NUM = 7;
    ...
    private Handler mHandler = new Handler(){
        public void handleMessage(Message msg) {
            ...
            case MSG_UPDATE_GPS_LOCATIONFINISH:
                ...
                mbtnGpsConnect.setVisibility(View.GONE);
                mbtnGpsConnect1.setText(mContext
                        .getString(R.string.mtvgpssearsuccess) + mSateliteNum);
                mbtnGpsConnect1.setVisibility(View.VISIBLE);
                mtvPosTime
