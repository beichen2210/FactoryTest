...
#pss add for VFOZBENQ-15 20150825
PRODUCT_PACKAGES += CSDTEST
#chb add for FactoryTest:VFOZ-4  2015-7-27
PRODUCT_PACKAGES += FactoryTest
PRODUCT_PACKAGES += libbacklightJni
PRODUCT_PACKAGES += libBatteryJni
PRODUCT_PACKAGES += libmacAddrJni
#chb add for Run In:VFOZ-58 2015-8-17
PRODUCT_PACKAGES += FactoryAutoTest
#chb add for VFOZBAUBQ-2 2015-8-25
PRODUCT_PACKAGES += Kogan
#chb modify for VFOZBAUBQ-55 ：copy Factorytest -> CSDTool begin 2015.9.8
PRODUCT_PACKAGES += CSDTool
PRODUCT_PACKAGES += libcsdbacklightJni
PRODUCT_PACKAGES += libcsdBatteryJni
PRODUCT_PACKAGES += libcsdmacAddrJni
#chb modify for VFOZBAUBQ-55 ：copy Factorytest -> CSDTool end 2015.9.8
...
#chb modify for VFOZBAUBQ-54 old :iAmCdRom.iso
ifeq ($(strip $(MTK_BICR_SUPPORT)), yes)
PRODUCT_COPY_FILES += device/mediatek/common/B506_KG.iso:system/etc/B506_KG.iso
endif
...
#yutianliang add VFOZBENQ-31 begin
  PRODUCT_PACKAGES += QotaGcmClient \
                        SystemUpdateInstaller \
                        SystemUpdateService
#yutianliang add VFOZBENQ-31 end
