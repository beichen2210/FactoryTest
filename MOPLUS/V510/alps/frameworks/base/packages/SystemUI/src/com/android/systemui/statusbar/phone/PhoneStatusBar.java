...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        //caoqiaofeng add MTSFEFL-14 20150323 start 
        //mGestureController = new GestureControllerImpl(mContext);//yutianliang delete for VFOZ-57 VFOZBENQ-143
	 ...
	 TextView mPercentage = (TextView) mStatusBarView.findViewById(R.id.percentage);
        ...
        if (mQSPanel != null) {
            final QSTileHost qsh = new QSTileHost(mContext, this,
                    ...
                    //caoqiaofeng add MTSFEFL-14 20150323 start                    
                    //,mGestureController//yutianliang delete for VFOZ-57 VFOZBENQ-143
	...
	//chb add for factorytest:VFOZ-2 2015-7-27 begin
		...
		//pss modify for VFOZBENQ-96 20150912 start
		...
		if (mIsRecentAppsDisable
				&& (activityManager.getRunningTasks(1).get(0).topActivity
						.getClassName().equals(
								"com.mlt.factorytest.ItemTestActivity") || activityManager.getRunningTasks(1).get(0).topActivity
						.getClassName().equals(
								"com.mlt.csdfactorytest.ItemTestActivity"))) {
		}
		//pss modify for VFOZBENQ-96 20150912 end
		else{
		       awakenDreams();
	               toggleRecentApps();
		}
