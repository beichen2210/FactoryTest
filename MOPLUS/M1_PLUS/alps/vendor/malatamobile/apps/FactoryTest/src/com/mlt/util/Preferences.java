...
/*        SharedPreferences mPfc = context.getSharedPreferences(mName,
    ...
    {
        return (Settings.System.getInt(context.getContentResolver(), Settings.System.ENABLE_FP_LOCKSCREEN, -1) == 1) ? true : false; 
    }
    
    public static void setIsEnableFpUnlockscreen(Context context,
            boolean bEnabled)
    {
	 Settings.System.putInt(context.getContentResolver(), Settings.System.ENABLE_FP_LOCKSCREEN, bEnabled ? 1 : 0);
