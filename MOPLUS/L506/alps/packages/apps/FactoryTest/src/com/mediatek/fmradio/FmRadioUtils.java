...
public class FmRadioUtils {
    ...
    public static final int DEFAULT_STATION = 1002;
    ...
    // short antenna
    private static final boolean IS_FM_SHORT_ANTENNA_SUPPORT = SystemProperties
            .getBoolean("ro.mtk_fm_short_antenna_support", false);
     ...
     * 
     * @param recordingSdcard
     *            The recording sdcard path
     * 
