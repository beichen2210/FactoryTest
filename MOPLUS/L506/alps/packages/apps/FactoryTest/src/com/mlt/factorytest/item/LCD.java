...
public class LCD extends AbsHardware implements OnClickListener {
    ...
    private static int mImageNum = 5;//chb modify for VFOZBAUBQ-155 at 20151022 add gray picture
    ...
    public void onResume() {
        ...
        super.onResume();
        mivPicture.setBackgroundColor(Color.RED);//chb modify for VFOZESGW-72 at 20151016
        mImageNum = 5; //chb modify for VFOZBAUBQ-155 at 20151022 add gray picture
        // mView.setOnTouchListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
        case R.id.img_lcd:
            //{@ chb modify for VFOZBAUBQ-155 at 20151022 add gray picture begin
            if  (mImageNum == 5) {
                ...
                mImageNum--;
            	 ...
            	 mivPicture.setBackgroundResource(R.drawable.gray);
                 mImageNum--;
            } else if (mImageNum == 0) {
            ...
            //@} chb modify for VFOZBAUBQ-155 at 20151022 add gray picture end
            break;
