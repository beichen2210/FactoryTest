...
public class SpecialCharSequenceMgr {
	...
	//tiandajiao add for MTSFEFL-17 end 20150313
    // ADD BY hgx for factorytest 2015-2-2
    ...
    public static boolean handleChars(Context context, String input, EditText textField) {
        ...
        if (handleDeviceIdDisplay(context, dialString)
				...
				||handleFactoryTestModeEntry(context,dialString) // hgx add for factorytest 2015-2-2
    ...
    //tiandajiao add for MTSFEFL-17 end 20150313
	 ...
	 //hgx modify for FactroyTest  begin  activity  2015-2-2
	static private boolean handleFactoryTestModeEntry(Context context,
				String input){
			if(input.equals(FACTORYTEST_MODE_MALATA_ENTRY)){
				//showSarInfoPanel(context);
