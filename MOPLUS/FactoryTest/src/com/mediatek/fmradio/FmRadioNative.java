...
public class FmRadioNative {
    static {
        System.loadLibrary("fmmediatekjni");
    }
     ...
     * 
     * @param rdson
     *            The rdson (true, open; false, close)
     * 
     * @return rdsset
     */
     ...
     * 
     * @param which
     *            0 is RX ON, 1 is TX ON, 2 is TX Scaning
     ...
     * 
     * @return hardware version information array(0, ChipId; 1, EcoVersion; 2,
     *         PatchVersion; 3, DSPVersion)
     */
